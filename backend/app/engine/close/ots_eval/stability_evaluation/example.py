...
def example_close():
    ...
    print(
        "Total CLOSE Score with CLUSTERING quality measure: ", str(t_clustering_score)
    )
    return
...
def example_fcsets():
    ...
    test_data = {
        1: numpy.array(
            [[0.999, 0.9905, 0.989, 0.002, 0.028], [0.001, 0.0005, 0.011, 0.998, 0.972]]
        ),
        2: numpy.array(
            [[0.999, 0.9905, 0.989, 0.002, 0.028], [0.001, 0.0005, 0.011, 0.998, 0.972]]
        ),
    ...
    test_data = {
        1: numpy.array(
            [[0.999, 0.9905, 0.01, 0.002, 0.028], [0.001, 0.0005, 0.99, 0.998, 0.972]]
        ),
        2: numpy.array(
            [[0.999, 0.9905, 0.989, 0.002, 0.028], [0.001, 0.0005, 0.011, 0.998, 0.972]]
        ),
    ...
    clustering_score = rate_fuzzy_clustering(test_data)
    print(
        "Total FCSETS Score with 1/5 transitioning time series: ", str(clustering_score)
    )
    return

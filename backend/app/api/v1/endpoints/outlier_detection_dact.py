...
def set_settings_dact(settingsDact: SettingsDact, request: Request):
    state = request.app.state.dact
    state.settings_dact = settingsDact
...
def run(request: Request):
    ...
    if not hasattr(state, "settings_dact"):
    ...
    dact = Dact(dataset_df, state.settings_dataset, state.settings_dact)

...
const fileUploadEndpoint = "clustering-evaluation/close/dataset";
const fileSettingsEndpoint = "clustering-evaluation/close/settings-dataset";
...
export const FileUpload = () => {
  ...
  const { setShowResultCard } = React.useContext(CloseContext);

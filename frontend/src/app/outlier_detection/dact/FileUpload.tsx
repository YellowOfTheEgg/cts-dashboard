...
const fileUploadEndpoint = "outlier-detection/dact/dataset";
const fileSettingsEndpoint = "outlier-detection/dact/settings-dataset";
...
export const FileUpload = () => {
  ...
  const { setShowResultCard } = React.useContext(DactContext);

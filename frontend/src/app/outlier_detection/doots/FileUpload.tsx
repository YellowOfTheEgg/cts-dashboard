...
const fileUploadEndpoint = "outlier-detection/doots/dataset";
const fileSettingsEndpoint = "outlier-detection/doots/settings-dataset";
...
export const FileUpload = () => {
  ...
  const { setShowResultCard } = React.useContext(DootsContext);
